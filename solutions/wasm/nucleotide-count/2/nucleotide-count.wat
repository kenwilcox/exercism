(module
  ...
  (func (export "countNucleotides") (param $offset i32) (param $length i32) (result i32 i32 i32 i32)
    ...
    (loop $loop
      ...
      (if (i32.eq (local.get $char)(i32.const 65)) (then 
        (local.set $A (i32.add(local.get $A)(i32.const 1)))
      ) (else (if (i32.eq (local.get $char)(i32.const 67)) (then 
        (local.set $C (i32.add(local.get $C)(i32.const 1)))
      ) (else (if (i32.eq (local.get $char)(i32.const 71)) (then 
        (local.set $G (i32.add(local.get $G)(i32.const 1)))
      ) (else (if (i32.eq (local.get $char)(i32.const 84)) (then 
